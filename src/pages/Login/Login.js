                    ...
                    <div className="col-start-2 col-span-3 h-full text-gray-800">
                        <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
                            <div onClick={() => {
                                ...
                                <img title='Trở về trang chủ' src="https://kinhmatanna.com/wp-content/uploads/2022/06/Rectangle-656.jpg" className="w-5/6 rounded shadow-2xl drop-shadow-2xl mb-8 cursor-pointer" alt='' />
                            </div>
                            <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                                <form onSubmit={formik.handleSubmit}>
                                    <div className="w-full flex justify-center lg:justify-center">
                                        <div className='text-center'>
                                            <p className="text-2xl uppercase font-bold">Đăng nhập</p>
                                            <p className="text-lg">Hãy đăng nhập để được hưởng đặc quyền riêng dành cho bạn</p>
                                        </div>
                                    </div>
                                    <div className="mb-6">
                                    ...
                                    <div className="text-center lg:text-left">
                                        ...
                                        <p className="text-sm text-center font-semibold mb-0">
                                            ...
                                            <NavLink to={_register} className="ml-2 text-teal-500 hover:text-teal-700 underline focus:text-red-700 transition duration-200 ease-in-out">Đăng ký ngay</NavLink>
                                        </p>
                                    </div>
                                </form>
                            </div>
